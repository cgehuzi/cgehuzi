...
- [RegExp - регулярные выражения](#regexp---регулярные-выражения)
  - [RegExp : примеры](#regexp--примеры)
    ...
    - [11. Флаги](#11-флаги)
  - [RegExp : использование](#regexp--использование)
...
## RegExp : использование

```js
____.match(new RegExp(expression, flags));

// expression --> строка с выражением без оборачивания в / **** /, только ****
