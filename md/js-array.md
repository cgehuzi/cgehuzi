...
for (let planet of planets) {
  planet = `${planets.indexOf(planet) + 1}:${planet}`;
  console.log(planet);
}
// 1:Меркурий
// 2:Венера
...
planets.map((item, index) => `${index}:${item}`;
// ==> ['0:Меркурий', '1:Венера', '2:Земля', '3:Марс']
...
planets.flatMap((item, index) => [index, item];
// ==> [0, 'Меркурий', 1, 'Венера', 2, 'Земля', 3, 'Марс']

planets.map((item, index) => [index + 1, item];
// ==> [[0, 'Меркурий'], [1, 'Венера'], [2, 'Земля'], [3, 'Марс']]
...
planets.filter((item, index) => item.length < 7 && index > 1;
// ==> ['Земля', 'Марс']
...
planets.reduce((acc, item, index) => `${acc} --> ${index}:${item}`, 'От Солнца:');
// ==> 'От Солнца: --> 0:Меркурий --> 1:Венера --> 2:Земля --> 3:Марс'
...
planets.reduceRight((acc, item, index) => `${acc} --> ${index}:${item}`, 'К Солнцу:');
// ==> 'К Солнцу: --> 3:Марс --> 2:Земля --> 1:Венера --> 0:Меркурий'
...
planets.find((item, index) => item.length < 7 && index > 1); // ==> 'Земля'
planets.find((item, index) => item.length < 3); // ==> undefined
...
planets.findIndex((item, index) => item.length < 7 && index > 1); // ==> 2
planets.findIndex((item, index) => item.length < 3); // ==> -1
...
planets.some((item, index) => item.length < 7 && index > 1); // ==> true
planets.some((item, index) => item.length < 3); // ==> false
...
planets.every((item, index) => item.length > 3 && index < 4); // ==> true
planets.every((item, index) => item.length < 6); // ==> false
